...
if [ $NUMBER_F = 0 ]; then
    echo "[06:03AM]: No files in the data directory." >> /home/jline/ref.txt
    ...
    if [ $NUMBER_F != $(($NUMBER_TILES*48)) ]; then
        echo "[06:03AM]: MISSING FILES IN DATA DIRECTORY!" >> /home/jline/ref.txt
        echo "[06:03AM]:" $NUMBER_F "files instead of" $(($NUMBER_TILES*48))"." >> /home/jline/ref.txt
